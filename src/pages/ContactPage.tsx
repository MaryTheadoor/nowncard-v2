      ...
      <main className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="space-y-5">
          ...
          <a
            ...
            className="flex items-center gap-4 bg-tile border border-line rounded-2xl p-5 hover:border-accent-text transition no-underline group"
          >
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold text-ink group-hover:text-accent-text transition">Email Support</h2>
              <p className="text-sm text-ink-muted">support@nowncard.com</p>
            </div>
            <ArrowRight className="w-4 h-4 text-ink-faint group-hover:text-accent-text transition" />
          </a>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold text-ink group-hover:text-accent-text transition">Report a Bug</h2>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold text-ink group-hover:text-accent-text transition">Feature Request</h2>
        ...
        <div className="mt-10 bg-tile border border-line rounded-2xl p-6">
          ...
          <div className="space-y-3 text-sm text-ink-muted">
            <details className="group">
              <summary className="cursor-pointer font-semibold text-ink hover:text-accent-text transition list-none flex items-center justify-between">
              ...
              <p className="mt-2 pl-1">
                Sign in, go to your <Link to="/dashboard" className="text-accent-text hover:underline">Dashboard</Link>, and click "New Card." Fill in your details, customize the design, and save.
              </p>
            </details>
            ...
            <details className="group">
              ...
              <p className="mt-2 pl-1">
                Visit the <Link to="/#pricing" className="text-accent-text hover:underline">Pricing</Link> section and select your plan. To cancel, contact us at support@nowncard.com.
              </p>
            </details>
            <div className="h-px bg-line-soft" />
            <details className="group">
              ...
              <p className="mt-2 pl-1">
                Yes. Your data is encrypted in transit (HTTPS/TLS) and stored securely via Google Firebase. See our <Link to="/privacy" className="text-accent-text hover:underline">Privacy Policy</Link> for details.
              </p>
            </details>
          </div>
        </div>
